...
const InstagramHighlights = () => {
  return (
    <div className="bg-[#EBEAEA]">
      <div className="bg-[url('/gaikwad-pattern-red-white.png')] bg-cover bg-center bg-no-repeat relative h-[73vh] md:h-[76vh] lg:h-[80vh] 2xl:h-[70vh] md:overflow-x-hidden">
